...
namespace chat
{
    ...
    public:
        ...
        virtual bool BindSession(ConnectionId connection_id,
                                 const ConnectionSession &session) = 0;
    ...
    public:
        ...
        bool BindSession(ConnectionId connection_id,
                         const ConnectionSession &session) override;

        std::optional<ConnectionId> GetConnectionId(UserId user_id) override;

        std::optional<ConnectionSession> GetSession(
